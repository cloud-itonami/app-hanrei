...
| **Japan source DIDs** | 2 | kanpo (gazette), egov (legislation) |
| **Total** | 83 jurisdictions + 6 JP courts + 2 JP sources |
...
- Read: `createKyselyDb(env.HYPERDRIVE).selectFrom(...)` → graph Worker → Hyperdrive RisingWave
- Heartbeat: OK
